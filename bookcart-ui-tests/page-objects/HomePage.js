...
export class HomePage {
   ...
   */
    ...
    constructor(page) {
        ...
        this.selectContentFirstResult = page.locator("(//div[@class='p-1 ng-star-inserted'])").first();
        this.titleOfContentFirstResult = page.locator("div[class='card-title my-2'] a strong").first();
        this.priceOfContentFirstResult = page.locator("mat-card-content[class='mat-mdc-card-content'] p").first();
